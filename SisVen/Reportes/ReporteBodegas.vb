...
Public Class ReporteBodegas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisVen.ReporteBodegas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteBodegas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteBodegas = New ReporteBodegas()
        rpt.Site = Me.Site
        Return rpt
    End Function
