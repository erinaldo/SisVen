...
Public Class ReporteTipoMov
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisVen.ReporteTipoMov.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteTipoMov
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteTipoMov = New ReporteTipoMov()
        rpt.Site = Me.Site
        Return rpt
    End Function
