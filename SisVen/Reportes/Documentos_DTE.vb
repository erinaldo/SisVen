...
Public Class Documentos_DTE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisVen.Documentos_DTE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDocumentos_DTE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Documentos_DTE = New Documentos_DTE()
        rpt.Site = Me.Site
        Return rpt
    End Function
