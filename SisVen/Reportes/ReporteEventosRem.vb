...
Public Class ReporteEventosRem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisVen.ReporteEventosRem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteEventosRem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteEventosRem = New ReporteEventosRem()
        rpt.Site = Me.Site
        Return rpt
    End Function
