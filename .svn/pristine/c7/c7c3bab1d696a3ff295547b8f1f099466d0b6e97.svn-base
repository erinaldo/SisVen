...
Public Class ReporteFamilias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisVen.ReporteFamilias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteFamilias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteFamilias = New ReporteFamilias()
        rpt.Site = Me.Site
        Return rpt
    End Function
