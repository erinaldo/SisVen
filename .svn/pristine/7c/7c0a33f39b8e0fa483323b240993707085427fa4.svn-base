Public Class IngresoEventosRem
    ...
    Private Sub bGuardar_Click(sender As Object, e As EventArgs) Handles bGuardar.Click
        ...
        If Not Buscar("Usuarios", "Usuario", xIDFuncionario.Text.Trim, "Usuario") Then
            MsgError("Funcionario No Encontrado")
            Exit Sub
        End If
        If Not ValidarCombo(cEvento) Then
        ...
        Mensaje("Datos Ingresados" + vbCrLf + "Boucher N° " & RmD.Fields("Id").Text)
