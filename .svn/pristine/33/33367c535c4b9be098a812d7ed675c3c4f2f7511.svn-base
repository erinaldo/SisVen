...
Namespace SisVenWS1
    ...
    Partial Public Class Service
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.SisVen.My.MySettings.Default.SisVen_SisVenWS1_Service
        ...
        Public Function IngresarCliente(ByVal wIdKey As String, ByVal wCliente As Double, ByVal wClienteRef As Double, ByVal wRut As String, ByVal wRazonSocial As String, ByVal wFantasia As String, ByVal wDireccion As String, ByVal wCiudad As String, ByVal wComuna As String, ByVal wGiro As String, ByVal wEmail As String, ByVal wNuevo As Boolean) As <System.Xml.Serialization.XmlElementAttribute("Ingresar_ClienteResult")> System.Data.DataTable
            Dim results() As Object = Me.Invoke("IngresarCliente", New Object() {wIdKey, wCliente, wClienteRef, wRut, wRazonSocial, wFantasia, wDireccion, wCiudad, wComuna, wGiro, wEmail, wNuevo})
            Return CType(results(0),System.Data.DataTable)
        End Function
        
        '''<remarks/>
        Public Overloads Sub IngresarClienteAsync(ByVal wIdKey As String, ByVal wCliente As Double, ByVal wClienteRef As Double, ByVal wRut As String, ByVal wRazonSocial As String, ByVal wFantasia As String, ByVal wDireccion As String, ByVal wCiudad As String, ByVal wComuna As String, ByVal wGiro As String, ByVal wEmail As String, ByVal wNuevo As Boolean)
            Me.IngresarClienteAsync(wIdKey, wCliente, wClienteRef, wRut, wRazonSocial, wFantasia, wDireccion, wCiudad, wComuna, wGiro, wEmail, wNuevo, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub IngresarClienteAsync(ByVal wIdKey As String, ByVal wCliente As Double, ByVal wClienteRef As Double, ByVal wRut As String, ByVal wRazonSocial As String, ByVal wFantasia As String, ByVal wDireccion As String, ByVal wCiudad As String, ByVal wComuna As String, ByVal wGiro As String, ByVal wEmail As String, ByVal wNuevo As Boolean, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("IngresarCliente", New Object() {wIdKey, wCliente, wClienteRef, wRut, wRazonSocial, wFantasia, wDireccion, wCiudad, wComuna, wGiro, wEmail, wNuevo}, Me.IngresarClienteOperationCompleted, userState)
        End Sub
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://wikets.cl/Consultar_Documentos", RequestElementName:="Consultar_Documentos", RequestNamespace:="http://wikets.cl/", ResponseElementName:="Consultar_DocumentosResponse", ResponseNamespace:="http://wikets.cl/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function ConsultarDocumentos(ByVal wIdKey As String, ByVal wCliente As Double, ByVal wFechaIni As Date, ByVal wFechaFin As Date, ByVal wTipoDoc As String) As <System.Xml.Serialization.XmlElementAttribute("Consultar_DocumentosResult")> System.Data.DataTable
            Dim results() As Object = Me.Invoke("ConsultarDocumentos", New Object() {wIdKey, wCliente, wFechaIni, wFechaFin, wTipoDoc})
            Return CType(results(0),System.Data.DataTable)
        End Function
        
        '''<remarks/>
        Public Overloads Sub ConsultarDocumentosAsync(ByVal wIdKey As String, ByVal wCliente As Double, ByVal wFechaIni As Date, ByVal wFechaFin As Date, ByVal wTipoDoc As String)
            Me.ConsultarDocumentosAsync(wIdKey, wCliente, wFechaIni, wFechaFin, wTipoDoc, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub ConsultarDocumentosAsync(ByVal wIdKey As String, ByVal wCliente As Double, ByVal wFechaIni As Date, ByVal wFechaFin As Date, ByVal wTipoDoc As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("ConsultarDocumentos", New Object() {wIdKey, wCliente, wFechaIni, wFechaFin, wTipoDoc}, Me.ConsultarDocumentosOperationCompleted, userState)
        End Sub
        ...
        Public Function ObtenerDocumento(ByVal wIdKey As String, ByVal wCliente As Double, ByVal wLocal As Integer, ByVal wTipoDoc As String, ByVal wNumero As Double, ByVal wModo As Integer) As <System.Xml.Serialization.XmlElementAttribute("Obtener_DocumentoResult")> System.Data.DataTable
            Dim results() As Object = Me.Invoke("ObtenerDocumento", New Object() {wIdKey, wCliente, wLocal, wTipoDoc, wNumero, wModo})
            Return CType(results(0),System.Data.DataTable)
        End Function
        
        '''<remarks/>
        Public Overloads Sub ObtenerDocumentoAsync(ByVal wIdKey As String, ByVal wCliente As Double, ByVal wLocal As Integer, ByVal wTipoDoc As String, ByVal wNumero As Double, ByVal wModo As Integer)
            Me.ObtenerDocumentoAsync(wIdKey, wCliente, wLocal, wTipoDoc, wNumero, wModo, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub ObtenerDocumentoAsync(ByVal wIdKey As String, ByVal wCliente As Double, ByVal wLocal As Integer, ByVal wTipoDoc As String, ByVal wNumero As Double, ByVal wModo As Integer, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("ObtenerDocumento", New Object() {wIdKey, wCliente, wLocal, wTipoDoc, wNumero, wModo}, Me.ObtenerDocumentoOperationCompleted, userState)
        End Sub
